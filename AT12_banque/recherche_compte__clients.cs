...
{
    public partial class recherche_compte__clients : Form
    {
        banqueEntities Bq;
        public recherche_compte__clients()
        {
            InitializeComponent();
        }

        private void recherche_compte__clients_Load(object sender, EventArgs e)
        {
